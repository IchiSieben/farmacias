...
function Miniatura({ p, dic, tam }: { p: Producto; dic: Textos; tam: number }) {
...
function Tendencia({ p, cadena, idioma, dic }: { p: Producto; cadena: string; idioma: Idioma; dic: Textos }) {
...
function ResumenAhorro({ p, activas, idioma, dic, compacto }: Omit<PiezaProps, 'base'> & { compacto?: boolean }) {
...
function Precio({ p, c, idioma, dic, masBarato }: { p: Producto; c: Cadena; idioma: Idioma; dic: Textos; masBarato: boolean }) {
...
function enlaceFicha(p: Producto, idioma: Idioma, base: string) {
